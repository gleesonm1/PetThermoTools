...
class MELTSengine(object):
    ...
    mass = None
    # OUTPUT: Dictionary of log 10 viscosity (Poise) for one or more liquid phases.
    viscosity = None
    ...
    def calcEquilibriumState(self, runMode=None, outputFlag=1, name='', *args):
        ...
        numberPhases = c_int(10)
        indices = [0] * 10
        phaseIndices = (c_int * len(indices)) (*indices)
        phases = create_string_buffer(10*20)
        ...
        nc = nf + nox + 3
        propArr = [0.0] * (nc*10) # numberPhases
